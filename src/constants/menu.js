  ...
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        label: "menu.application-preference",
        to: "/app/second-menu/second",
      },
      {
        icon: "iconsminds-financial",
        label: "menu.assoc-posw/benfits",
        to: "/app/second-menu/second",
      },
      {
        icon: "iconsminds-photo-album-2",
        label: "menu.assoc-position/evalution",
        to: "/app/second-menu/second",
      },
      {
        icon: "iconsminds-bird-delivering-letter",
        label: "menu.setup-letter",
        to: "/app/second-menu/second",
      },
      {
        icon: "iconsminds-mail-settings",
        label: "menu.setup-sms",
        to: "/app/second-menu/second",
      },
    ],
  },
